...
class WPWatcherDataBase:
    ...
    def update_and_write_wp_reports(self, new_wp_report_list:List[Dict[str, Any]]) -> None:
    ...
    def find_last_wp_report(self, wp_report:Dict[str, Any]) -> Optional[Dict[str, Any]]:
